...
export default function GoalkeeperDashboard() {
  ...
  const gf = (id: string) =>
    forms[id] || { msg: "", tarifa: String(currentUser?.tarifa || BASE), horas: 2, mode: "offer" };
    ...
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <TouchableOpacity onPress={handleLogout}><Text style={styles.logoutText}>Salir</Text></TouchableOpacity>
        </View>
      </View>
                ...
                <View key={svc.id} style={[styles.card, canEnd && { borderColor:"rgba(0,255,135,.4)" }]}>
                  ...
                  {canEnd && (
                    <View style={[styles.actionBox, styles.actionBoxRed]}>
                      ...
                      <Text style={styles.actionHint}>Presiona al finalizar el partido.</Text>
                      <TouchableOpacity style={styles.btnEnd} onPress={() => endService(svc.id)}>
                        <Text style={styles.btnEndText}>■  Finalizar servicio</Text>
                      </TouchableOpacity>
                    </View>
                  )}
