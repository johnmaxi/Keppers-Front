...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const msg =
        e?.code === "auth/user-not-found"     ? "Correo no registrado" :
...
const styles = StyleSheet.create({
  container:        { flex: 1, backgroundColor: "#0a0a0f", alignItems: "center", padding: 24, paddingTop: 80 },
  ...
  input:            { backgroundColor: "#16161f", borderWidth: 1.5, borderColor: "#2a2a35", color: "#f0ede8", padding: 13, borderRadius: 4, fontSize: 14 },
  btnPrimary:       { backgroundColor: "#00ff87", paddingVertical: 15, borderRadius: 4, alignItems: "center", marginTop: 24 },
